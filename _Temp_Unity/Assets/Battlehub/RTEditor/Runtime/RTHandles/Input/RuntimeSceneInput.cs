...
namespace Battlehub.RTHandles
{
    public class RuntimeSceneInput : RuntimeSelectionInput
    {
        ...
        public float MoveBoost = 0.25f;
        public float ZoomBoost = 0.25f;
        ...
        protected override void LateUpdate()
        {
            ...
            if (m_freeMove)
            {
                ...
                Vector3 moveAxes = MoveAxes() * FreeMoveSensitivity * MoveBoost * GetBoost();
                float zoomAxis = ZoomAxis() * FreeZoomSensitivity * ZoomBoost * GetBoost();
        ...
        {
            if (Input.GetKey(KeyCode.LeftShift) || Input.GetKey(KeyCode.RightShift)) { return ShiftBoost; }
            return 1f;
        }
    }
}
